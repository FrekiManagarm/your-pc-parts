...
import { AnimatedInput } from "@/components/animations/input";
  ...
  return (
    <div className="flex flex-col h-screen w-screen justify-center items-center">
      <div className="flex flex-col justify-center items-center max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
        ...
        />
        <h2 className="font-bold text-xl text-center text-neutral-800 dark:text-neutral-200 pt-5">
          Welcome to Your PC Parts
        </h2>
        <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
          Login to enjoy all of our features
        </p>

        <form className="my-8 w-full" onSubmit={handleSubmit}>
          <LabelInputContainer className="mb-4">
            <Label htmlFor="email">Email Address</Label>
            <AnimatedInput id="email" placeholder="john.doe@icloud.com" type="email" />
          </LabelInputContainer>
          <LabelInputContainer className="mb-4">
