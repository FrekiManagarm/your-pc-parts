...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center bg-transparent justify-center rounded-md px-4 py-2 text-sm font-semibold transition-colors focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-primary/50 data-[state=open]:bg-primary/50 data-[active]:text-white data-[state=open]:text-white"
)
