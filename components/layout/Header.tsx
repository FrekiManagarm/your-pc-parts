    ...
    ? null : (
      <>
        <header className="md:flex flex-row pt-0 md:pt-6 hidden">
          <motion.div className="mx-auto flex w-full flex-row items-center justify-between rounded-none bg-secondary bg-opacity-80 px-5 py-1 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] md:w-fit md:rounded-full dark:border-black/40 dark:bg-gray-800/60 dark:bg-opacity-75">
            <Link href="/">
              <Image
                src="/logo-ypcp.png"
                alt="logo website"
