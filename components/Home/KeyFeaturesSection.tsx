      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl dark:text-white">Unleash Your Potential</h2>
        ...
        <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
          <div className="flex flex-col justify-center space-y-4">
            <CheckIcon className="mx-auto h-10 w-10 dark:text-white" />
            <h3 className="text-xl font-bold text-center dark:text-white">High Performance</h3>
          ...
          <div className="flex flex-col justify-center space-y-4">
            <CheckIcon className="mx-auto h-10 w-10 dark:text-white" />
            <h3 className="text-xl font-bold text-center dark:text-white">Innovative Design</h3>
            <p className="text-gray-500 dark:text-gray-400 text-center">
