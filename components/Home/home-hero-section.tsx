  ...
  return (
    <section className="h-screen w-screen flex flex-col justify-center items-center text-center lg:pb-40">
      <div className="h-screen w-screen flex flex-col justify-center items-center text-center">
        <h1 className="lg:max-w-[1000px] md:max-w-[800px] max-w-[600px] from-primary via-accent to-secondary bg-gradient-to-r bg-clip-text font-bold tracking-tighter text-transparent text-7xl lg:text-[10rem] animate-gradient">
